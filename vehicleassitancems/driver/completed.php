                                ...
                                <div class="table-responsive">
                                    ...
                                    <th>Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                               <?php
    $did = $_SESSION['vamsdid'];    $sql = "SELECT * from  tblbook where Status='Completed' && AssignTo=:did";    $query = $dbh->prepare($sql);    $query->bindParam(':did', $did, PDO::PARAM_STR);    $query->execute();    $results = $query->fetchAll(PDO::FETCH_OBJ);
