...
<head>
    ...
    <title>Vehicle Break Down Assistance Management System: Inprogress Request</title>
       ...
       <?php include_once('includes/sidebar.php'); ?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Inprogress Request</a>
            </nav>
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Inprogress</strong> Request </h2>
                            </div>
                            <div class="body">
                                <div class="table-responsive">
                                    ...
                                    <th>Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                               <?php
    $did = $_SESSION['vamsdid'];    $sql = "SELECT * from  tblbook where Status='On The Way' && AssignTo=:did";    $query = $dbh->prepare($sql);    $query->bindParam(':did', $did, PDO::PARAM_STR);    $query->execute();    $results = $query->fetchAll(PDO::FETCH_OBJ);
